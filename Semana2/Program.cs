  ...
  static void AdicionarTarefa()
{
    ...
    Console.WriteLine("Digite a data de vencimento da tarefa (dd/MM/yyyy):");
    DateTime dataVencimento;
    if (DateTime.TryParseExact(Console.ReadLine(), "dd/MM/yyyy", null, System.Globalization.DateTimeStyles.None, out dataVencimento))
    {
    ...
    static void ExibirTarefasPendentes()
    {
    ...
    static void ExibirTarefasConcluidas()
    {
